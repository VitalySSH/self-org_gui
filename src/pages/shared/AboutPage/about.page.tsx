      ...
      description: [
        {
          ...
          content: "Участники публикуют сложные задачи, которые не удаётся решить в одиночку — от локальных проблем до глобальных вызовов. В качестве решений принимаются любые идеи, включая строгие научные гипотезы и нестандартные аналогии."
        },
        {
          type: "paragraph",
          strong: "Анализ вкладов",
          content: "ИИ-модель обрабатывает предложения и выделяет ключевые элементы — факты, гипотезы, аналогии и кросс-дисциплинарные связи. Алгоритмы группируют схожие идеи, сохраняя при этом неочевидные ассоциации."
        },
        {
          type: "paragraph",
          strong: "Синтез решений",
          content: "Система комбинирует наиболее перспективные элементы из разных вкладов и создаёт промежуточные решения. Участники могут бесконечно дорабатывать их, наблюдая эволюцию идеи через интерактивный граф связей."
        },
        {
          type: "paragraph",
          strong: "Коллективный интеллект",
          content: "Модуль усиливает сильные стороны сообщества — человеческую креативность и способность работать с контекстом, дополняя их возможностями ИИ по обработке больших объёмов структурированных данных."
        }
      ]
    },
    {
        ...
        <section className="content-section">
          ...
          <Card className="research-card">
            <Paragraph className="research-description">
              Коллективный интеллект возникает, когда группа людей вырабатывает решения,
              превосходящие возможности отдельных участников. Исследования показывают,
              что эффективность такого взаимодействия напрямую зависит от качества коммуникации между участниками.
            </Paragraph>
            <Paragraph className="research-description">
              Мы выдвигаем гипотезу, что наша платформа преодолевает ключевые ограничения
              группового взаимодействия: доминирование активных участников, поляризацию мнений
              и утрату ценных идей. Эти проблемы особенно выражены в цифровых дискуссиях с
              сотнями и тысячами участников, где традиционные форматы перестают работать.
            </Paragraph>
            <Paragraph className="research-description">
              Используя современные технологии обработки естественного языка, система обеспечивает равноправное участие,
              выявляет глубинные связи между идеями и преобразует многообразие мнений в эффективные решения.
            </Paragraph>
            <Paragraph className="research-description">
              Мы предполагаем, что такой подход позволяет достичь нового уровня
              коллективного интеллекта при одновременном выполнении следующих условий:
            </Paragraph>
