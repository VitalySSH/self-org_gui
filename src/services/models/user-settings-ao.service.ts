...
import {
    ...
    CommunityNameModel, InitiativeCategoryModel, StatusModel,
...
export class UserSettingsAoService
    ...
    async saveSettings(
        ...
        categoriesFieldData: InitiativeCategoryModel[],
        communityId: string,
        user: UserModel,
        ...
        settings.init_categories = categories as InitiativeCategoryModel[];
    ...
    private async _getOrCreateCategories(
        fieldData: InitiativeCategoryModel[],
        communityId: string,
        user: UserModel,
    ) {
        if (fieldData.length) {
            const categories: InitiativeCategoryModel[] = [];
