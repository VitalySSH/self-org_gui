...
export function ParticipationInviteModal({
  ...
  const hasMultipleSolutions = totalSolutions > 1;
            ...
            >
              <div className="option-content">
                ...
                <div className="option-info">
                  ...
                  <p>
                    ИИ проанализирует существующие решения и предложит основные
                    направления подходов. Выберите подходящее вам.
                  </p>
                  <div className="option-features">
                    <span>🤖 Анализ ИИ</span>
          ...
          <div className="info-section">
            ...
            <div className="info-text">
              ...
              <p>
                ...
                коллективного интеллекта: запрос идей, предложений по улучшению
                и конструктивной критики от ИИ.
              </p>
            </div>
          </div>
