...
export const IsMinorityNotParticipateLabel = 'Меньшинство должно участвовоать в инициативах';
export const IsExtraOptionsLabel = 'Требуется определить дополнительные параметры при голосовании?';
